#!/usr/bin/env python3
"""
GUARDRAILS DEMO - Interactive Presentation for Leadership
==========================================================

This demo shows:
1. BEFORE: What happened without guardrails
2. AFTER: How guardrails protect the system
3. LIVE TEST: Real-time blocking and redaction

Run this script to demonstrate guardrails to stakeholders.
"""
...
Working on AI and ML projects using Python."""
    ...
    pause("Press Enter to apply redaction...")

    # Apply redaction
    print("\n⏳ Applying guardrails redaction...", end='', flush=True)
    time.sleep(1)
...
def main():
    ...
    print("   1. The problem (without guardrails)")
    print("   2. The solution (with guardrails)")
    print("   3. Live blocking tests (real-time)")
    print("   4. Live redaction tests (real-time)")
    print("   5. System architecture")
    print("   6. Before/after comparison")
    print("   7. Key takeaways for leadership")
